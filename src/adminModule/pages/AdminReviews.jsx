  ...
  const toggleReviewStatus = async (reviewId, currentStatus) => {
    try {
      ...
      setReviews(reviews.map(review => 
        review._id === reviewId ? { ...review, isApproved: newStatus } : review
      ));
            ...
            <tbody>
              {currentReviews.length > 0 ? (
                currentReviews.map((review) => (
                  <tr key={review._id}>
                    <td>
                      <Link to={`/product/${review.product._id}`} target="_blank">
                        {review.product.name}
                      </Link>
                    </td>
                    ...
                    <td>
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={() => toggleReviewStatus(review._id, review.isApproved)}
                        />
