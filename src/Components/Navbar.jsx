...
const Navbar = () => {
   ...
   return (
      <>
         <div className="top-0 py-1 lg:py-1 w-full  bg-gray-300 lg:relative z-50 ">
            <nav className="z-10 sticky top-0 left-0 right-0 max-w-4xl xl:max-w-5xl mx-auto px-5 py-2 lg:border-none lg:py-3">
